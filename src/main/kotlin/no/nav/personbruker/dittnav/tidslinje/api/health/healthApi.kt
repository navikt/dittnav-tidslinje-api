...
fun Routing.healthApi(httpClient: HttpClient, environment: Environment, collectorRegistry: CollectorRegistry = CollectorRegistry.defaultRegistry) {
    ...
    get("/internal/selftest") {
        call.pingDependencies(httpClient, environment)
    }
